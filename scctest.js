 ...
 * @Updated: 2026-06-28
 * @Fixed: 修复 Quantumult X 下 $persistentStore 未定义导致 Cookie 无法写入的 Bug
 */
...
// 兼容 Surge/Loon/Stash($persistentStore) 与 Quantumult X($prefs)
// 原代码只判断 $persistentStore，在 QuanX 中该对象为 undefined，导致数据静默丢失
function read(k){
